    ...
    docInfo && (
      <div>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0">
            ...
            <div className="flex items-center gap-2 text-sm mt-1 text-gray-600">
              ...
              <button className="py-1.5 px-2 border text-xs rounded-full">{docInfo.experience}</button>
            </div>
            <div>
        ...
        <div className="sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700">
            ...
            {docSlots.length > 0 &&
              docSlots[slotIndex].map((item, index) => (
                <p
                  ...
                  cursor-pointer ${item.Time === slotTime
                    ? 'bg-primary text-white' 
          ...
          <button className="bg-primary text-white text-sm font-light px-14 rounded-full py-3 my-6">Book an Appointment</button>
        </div>
        
        {/* Liste des médecins liés */}
        {docInfo.speciality && (
