    ...
    <div>
      ...
      <div>
        {doctors.slice(0, 2).map((item, index) => (
          <div key={index} className="grid grid-cols-1 sm:flex gap-4 sm:gap-6 py-2 border-b">
            <div>
              <img src={item.image || assets.defaultProfilePic} alt={item.name} className="w-32 bg-indigo-50" />
            </div>
